Feature: control multiple openflow switchies using sliceable_routing_switch
  ...
  Scenario: One openflow switch, 65535 slices, six servers, mac binding
    Given the slice table from script "../apps/sliceable_routing_switch/test/65535_slices.pl"
    ...
    When I try trema run "../apps/sliceable_routing_switch/sliceable_routing_switch -s tmp/slice.db -f tmp/filter.db" with following configuration (backgrounded):
      ...
      link "sliceable_routing_switch1", "host65535"
      link "sliceable_routing_switch1", "host65536"
      link "sliceable_routing_switch1", "host131069"
      link "sliceable_routing_switch1", "host131070"
