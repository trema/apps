#! /usr/bin/perl
#
# REST API for sliceable routing switch application.
#
...
my $SliceDBFile = "/home/sliceable_routing_switch/db/slice.db";
my $FilterDBFile = "/home/sliceable_routing_switch/db/filter.db";
my $Slice;
my $Filter;
my $CGI;
...
sub add_filters(){
	...
	my @criteria = ();
	$criteria[0] = ${$filter}{'priority'};
	$criteria[1] = ${$filter}{'ofp_wildcards'};
	$criteria[2] = ${$filter}{'in_port'};
	$criteria[3] = ${$filter}{'dl_src'};
	$criteria[4] = ${$filter}{'dl_dst'};
	$criteria[5] = ${$filter}{'dl_vlan'};
	$criteria[6] = ${$filter}{'dl_vlan_pcp'};
	$criteria[7] = ${$filter}{'dl_type'};
	$criteria[8] = ${$filter}{'nw_tos'};
	$criteria[9] = ${$filter}{'nw_proto'};
